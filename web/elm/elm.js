...
Elm.Saints.Address.make = function (_elm) {
   ...
   var viewingClass = function (model) {
      return $Html$Attributes.$class(model.editing ? "hide" : "");
   };
   var editingClass = function (model) {
      return $Html$Attributes.$class(model.editing ? "edit_details" : "hide");
   };
   ...
   var inputCountry = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("country")
              ...
              function (str) {
                 return A2($Signal.message,address,Country(str));
              })
              ,$Html$Attributes.value(model.country)]),
      _U.list([]));
   });
   var Zip = function (a) {    return {ctor: "Zip",_0: a};};
   var inputZip = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("zip")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Postal Code")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("zip")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var State = function (a) {    return {ctor: "State",_0: a};};
   var inputState = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("state")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("State or Province")
              ,$Html$Attributes.autofocus(true)
   ...
   var City = function (a) {    return {ctor: "City",_0: a};};
   var inputCity = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("city")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("City")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("city")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var Address2 = function (a) {
      return {ctor: "Address2",_0: a};
   };
   var inputAddress2 = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("address2")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Street Address")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("address2")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var Address1 = function (a) {
      return {ctor: "Address1",_0: a};
   };
   var inputAddress1 = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("address1")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Street Address")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("address1")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var inputLocation = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("location")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Location")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("location")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var NoOp = {ctor: "NoOp"};
   var makeModel = function (addr) {
      return {address: addr,editing: false};
   };
   var Model = F2(function (a,b) {
      return {address: a,editing: b};
   });
   var initAddress = {id: 0
                     ...
                     ,zip: ""
                     ,country: ""};
   var init = {address: initAddress,editing: false};
   var $new = function (donor_id) {
      var address = initAddress;
      var newAddress = _U.update(address,{donor_id: donor_id});
      return {address: newAddress,editing: true};
   };
   var addressUpdate = $Signal.mailbox(initAddress);
   var cancelSave = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,ToggleEditing)]),
   ...
   var addressDelete = $Signal.mailbox(initAddress);
      ...
      return _U.list([A2($Html.li,
                     ...
                     _U.list([$Html.text(addr.location)
                             ...
                             _U.list([deleteButtonStyle
                                     ,A2($Html$Events.onClick,addressDelete.address,addr)]),
                             _U.list([$Html.text("-")]))
                             ...
                             A2($Basics._op["++"],
                             addr.state,
                             A2($Basics._op["++"]," ",addr.zip)))))]))
                             ,A2($Html.p,_U.list([]),_U.list([$Html.text(addr.country)]))]))
                     ,A2($Html.li,
                     _U.list([]),
                     _U.list([A2($Html.ul,
                     _U.list([editingClass(model)]),
                     _U.list([A2($Html.li,
                             _U.list([]),
                             _U.list([A2($Html.span,
                                     _U.list([]),
                                     _U.list([A2(inputLocation,address,addr)]))
                                     ,A2(cancelSave,address,model)]))
                             ,A2($Html.li,
                             _U.list([]),
                             _U.list([A2(inputAddress1,address,addr)]))
                             ,A2($Html.li,
                             _U.list([]),
                             _U.list([A2(inputAddress2,address,addr)]))
                             ,A2($Html.li,_U.list([]),_U.list([A2(inputCity,address,addr)]))
                             ,A2($Html.li,_U.list([]),_U.list([A2(inputState,address,addr)]))
                             ,A2($Html.li,_U.list([]),_U.list([A2(inputZip,address,addr)]))
                             ,A2($Html.li,
                             _U.list([]),
                             _U.list([A2(inputCountry,address,addr)]))]))]))]);
   });
   var Address = F9(function (a,b,c,d,e,f,g,h,i) {
      return {id: a
             ,donor_id: b
             ,location: c
             ,address1: d
...
Elm.Saints.Note.make = function (_elm) {
   ...
   var SaveEdit = {ctor: "SaveEdit"};
   var ToggleEditing = {ctor: "ToggleEditing"};
   var Author = function (a) {    return {ctor: "Author",_0: a};};
   var Memo = function (a) {    return {ctor: "Memo",_0: a};};
   var inputMemo = F2(function (address,note) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("memo")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Memo")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("memo")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
   ...
   var NoOp = {ctor: "NoOp"};
   var makeModel = function (note) {
      return {note: note,editing: false};
   };
   var Model = F2(function (a,b) {
      return {note: a,editing: b};
   });
   var initNote = {id: 0
                  ,donor_id: 0
                  ,author: ""
                  ,memo: ""
                  ,updated_at: ""};
   var init = {note: initNote,editing: false};
   var newNote = function (donor_id) {
      var note = initNote;
      var newNote = _U.update(note,{donor_id: donor_id});
      return {note: newNote,editing: true};
   };
   var noteUpdate = $Signal.mailbox(initNote);
   var cancelSave = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "float"
   ...
   var noteDelete = $Signal.mailbox(initNote);
   var view = F2(function (address,model) {
      var note = model.note;
      return _U.list([A2($Html.li,
                     _U.list([A2($Html$Events.onClick,address,ToggleEditing)
                     ...
                     _U.list([$Html.text(A2($Basics._op["++"],
                             ...
                             _U.list([$Html.text(A2($Basics._op["++"],
                                     ...
                                     ,A2($Html.button,
                                     _U.list([deleteButtonStyle
                                             ,A2($Html$Events.onClick,noteDelete.address,note)]),
                                     _U.list([$Html.text("-")]))]))]))
                     ,A2($Html.li,
                     _U.list([]),
                     _U.list([A2($Html.ul,
...
Elm.Saints.Phone.make = function (_elm) {
   ...
   var inputNumber = F2(function (address,phone) {
      return A2($Html.p,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("number")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("number or email")
              ,$Html$Attributes.autofocus(true)
   ...
   var inputOfType = F2(function (address,phone) {
      return A2($Html.p,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("ofType")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Type (phone, email, etc.)")
              ,$Html$Attributes.autofocus(true)
   ...
   var inputLocation = F2(function (address,phone) {
      return A2($Html.p,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("location")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Location (home, office, etc.)")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("location")
              ,A3($Html$Events.on,
              "input",
   ...
   var ToggleEditing = {ctor: "ToggleEditing"};
   var NoOp = {ctor: "NoOp"};
   var makeModel = function (phone) {
      return {phone: phone,editing: false};
   };
   var Model = F2(function (a,b) {
      return {phone: a,editing: b};
   });
   var initPhone = {id: 0
                   ,donor_id: 0
                   ,location: ""
                   ,ofType: ""
                   ,number: ""};
   var init = {phone: initPhone,editing: false};
   var $new = function (donor_id) {
      var phone = initPhone;
      var newPhone = _U.update(phone,{donor_id: donor_id});
      return {phone: newPhone,editing: true};
   };
   var phoneUpdate = $Signal.mailbox(initPhone);
   var cancelSave = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "float"
   ...
   var phoneDelete = $Signal.mailbox(initPhone);
   var view = F2(function (address,model) {
      ...
      return _U.list([A2($Html.li,
                     ...
                     _U.list([$Html.text(A2($Basics._op["++"],
                             ...
                             ,A2($Html.button,
                             _U.list([deleteButtonStyle
                                     ,A2($Html$Events.onClick,phoneDelete.address,phone)]),
                             _U.list([$Html.text("-")]))]))
                     ,A2($Html.li,
                     _U.list([]),
                     _U.list([A2($Html.ul,
                     ...
                     _U.list([A2($Html.li,
                             ...
                             _U.list([A2($Html.span,
                                     _U.list([]),
                                     _U.list([A2(inputLocation,address,phone)]))
                                     ,A2(cancelSave,address,model)]))
                             ,A2($Html.li,
                             _U.list([]),
                             _U.list([A2(inputOfType,address,phone)]))
                             ,A2($Html.li,
                             _U.list([]),
                             _U.list([A2(inputNumber,address,phone)]))]))]))]);
   });
   var Phone = F5(function (a,b,c,d,e) {
      return {id: a,donor_id: b,location: c,ofType: d,number: e};
   });
...
Elm.Saints.Donor.make = function (_elm) {
   ...
   var detailsClass = function (model) {
      return $Html$Attributes.$class(model.hideDetails ? "hide_details" : "donor_details");
   };
   var editClass = function (model) {
      return $Html$Attributes.$class(model.hideEdit ? "hide_details" : "edit_details");
   };
   var editButton = function (model) {
      return $Html$Attributes.$class(model.hideEdit ? "edit_button" : "hide");
   };
   var donation = F2(function (address,model) {
      return A2($Html.input,
      _U.list([$Html$Attributes.id("donation")
              ,$Html$Attributes.type$("number")
              ,$Html$Attributes.placeholder("Donation")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("donation")
   ...
   var updatedDonorAddresses = F3(function (addresses,id,action) {
      var addrAction = function ($this) {
         ...
         id) ? A2($Saints$Address.update,action,$this) : $this;
      };
      return A2($List.map,addrAction,addresses);
   });
   var updatedDonorPhones = F3(function (phones,id,action) {
      var phoneAction = function ($this) {
         return _U.eq($this.phone.id,id) ? A2($Saints$Phone.update,
         action,
         $this) : $this;
      };
      return A2($List.map,phoneAction,phones);
   });
   var updatedDonorNotes = F3(function (notes,id,action) {
      var noteAction = function ($this) {
         return _U.eq($this.note.id,id) ? A2($Saints$Note.update,
         action,
         $this) : $this;
      };
      return A2($List.map,noteAction,notes);
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return model;
         case "OK": var foo = A2($Debug.log,"OK RESP",_p0._0);
           return model;
         ...
         case "NewNote": var donor = model.donor;
           ...
           {notes: A2($Basics._op["++"],
           donor.notes,
           _U.list([$Saints$Note.newNote(donor.id)]))});
           return _U.update(model,{donor: newDonor});
         case "NewAddress": var donor = model.donor;
           var newDonor = _U.update(donor,
           {addresses: A2($Basics._op["++"],
           donor.addresses,
   ...
   var ModifyPhone = F2(function (a,b) {
      return {ctor: "ModifyPhone",_0: a,_1: b};
   });
   var viewPhone = F2(function (address,model) {
      return A2($Saints$Phone.view,
      A2($Signal.forwardTo,address,ModifyPhone(model.phone.id)),
      model);
   });
   var ModifyAddr = F2(function (a,b) {
      return {ctor: "ModifyAddr",_0: a,_1: b};
   });
   var viewAddr = F2(function (address,model) {
      return A2($Saints$Address.view,
      A2($Signal.forwardTo,address,ModifyAddr(model.address.id)),
      model);
   });
   var ModifyNote = F2(function (a,b) {
      return {ctor: "ModifyNote",_0: a,_1: b};
   });
   ...
   var makeModel = F3(function (hideDetails,detailsInHand,donor) {
      return {donor: {id: donor.id
                     ...
                     ,phones: A2($List.map,$Saints$Phone.makeModel,donor.phones)
   ...
   var saveButton = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class(model.hideEdit ? "hide" : "save_button")
              ,A2($Html$Events.onClick,donorUpdate.address,model.donor)]),
      _U.list([$Html.text("Save")]));
   });
   var detailsGet = $Signal.mailbox(initDonor);
   var onClickDetails = F2(function (address,model) {
      return model.detailsInHand ? A2($Html$Events.onClick,
      address,
      ToggleDetails) : A2($Html$Events.onClick,
      detailsGet.address,
      model.donor);
   });
   var onEnterDetails = F2(function (address,model) {
      return model.detailsInHand ? A2($Html$Events.onMouseEnter,
      address,
      ToggleDetails) : A2($Html$Events.onMouseEnter,
      detailsGet.address,
      model.donor);
   });
   var view = F2(function (address,model) {
      ...
      viewNotes(address),
      donor.notes));
      var theseAddresses = $List.concat(A2($List.map,
      viewAddr(address),
      donor.addresses));
      var phones = $List.concat(A2($List.map,
      viewPhone(address),
      donor.phones));
      return A2($Html.li,
      _U.list([A2(onEnterDetails,address,model)
              ,A2($Html$Events.onMouseLeave,address,ToggleDetails)]),
      _U.list([A2($Html.span,
              _U.list([A2($Html$Events.onClick,address,ToggleEdit)]),
              _U.list([fullNameText(donor)
                      ,A2($Html.button,
                      _U.list([deleteButtonStyle(model)
                              ,A2($Html$Events.onClick,address,Delete)]),
                      _U.list([$Html.text("-")]))]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "float"
              ...
              _U.list([A2($Html.button,
                      _U.list([addButtonStyle(model)
                              ,A2($Html$Events.onClick,address,NewNote)]),
                      _U.list([$Html.text("+")]))
                      ,A2($Html.ul,_U.list([detailsClass(model)]),notes)]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([A2($Html.button,
                      _U.list([addButtonStyle(model)
                              ,A2($Html$Events.onClick,address,NewAddress)]),
                      _U.list([$Html.text("+")]))
                      ,A2($Html.ul,_U.list([detailsClass(model)]),theseAddresses)]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([A2($Html.button,
                      _U.list([addButtonStyle(model)
                              ,A2($Html$Events.onClick,address,NewPhone)]),
                      _U.list([$Html.text("+")]))
                      ,A2($Html.ul,_U.list([detailsClass(model)]),phones)]))]));
   });
...
Elm.ElmSaints.make = function (_elm) {
   ...
   var requestDonorDetail = Elm.Native.Port.make(_elm).outboundSignal("requestDonorDetail",
   function (v) {
      return {id: v.id
             ,title: v.title
             ...
             ,lastName: v.lastName
             ,nameExt: v.nameExt
             ,phones: Elm.Native.List.make(_elm).toArray(v.phones).map(function (v) {
                return {phone: {id: v.phone.id
                               ,donor_id: v.phone.donor_id
                               ,location: v.phone.location
                               ,ofType: v.phone.ofType
                               ,number: v.phone.number}
                       ,editing: v.editing};
             })
             ,addresses: Elm.Native.List.make(_elm).toArray(v.addresses).map(function (v) {
                return {address: {id: v.address.id
                                 ,donor_id: v.address.donor_id
             ...
             ,notes: Elm.Native.List.make(_elm).toArray(v.notes).map(function (v) {
                return {note: {id: v.note.id
                              ,donor_id: v.note.donor_id
                              ,author: v.note.author
                              ,memo: v.note.memo
   ...
   var deletePhone = Elm.Native.Port.make(_elm).outboundSignal("deletePhone",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,location: v.location
   ...
   $Saints$Phone.phoneDelete.signal);
   var updatePhone = Elm.Native.Port.make(_elm).outboundSignal("updatePhone",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,location: v.location
   ...
   $Saints$Phone.phoneUpdate.signal);
   var deleteAddress = Elm.Native.Port.make(_elm).outboundSignal("deleteAddress",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,location: v.location
   ...
   $Saints$Address.addressDelete.signal);
   var updateAddress = Elm.Native.Port.make(_elm).outboundSignal("updateAddress",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,location: v.location
   ...
   $Saints$Address.addressUpdate.signal);
   var deleteNote = Elm.Native.Port.make(_elm).outboundSignal("deleteNote",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,author: v.author
   ...
   $Saints$Note.noteDelete.signal);
   var updateNote = Elm.Native.Port.make(_elm).outboundSignal("updateNote",
   function (v) {
      return {id: v.id
             ,donor_id: v.donor_id
             ,author: v.author
   ...
   var updateDonor = Elm.Native.Port.make(_elm).outboundSignal("updateDonor",
   function (v) {
      return {id: v.id
             ,title: v.title
             ,firstName: v.firstName
   ...
   var donorOK = $Signal.mailbox($Saints$Donor.initDonor);
   ...
   var basicNav = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,
              ...
              ,A2($Html.button,
              _U.list([buttonStyle
                      ,A2($Html$Events.onClick,address,NewDonor)]),
              _U.list([$Html.text("New Donor")]))
   ...
   var viewDonors = F2(function (address,model) {
      ...
      A2($Signal.forwardTo,address,Modify(model.donor.id)),
      model);
   });
   var view = F2(function (address,model) {
   ...
   var OKDonor = function (a) {
      return {ctor: "OKDonor",_0: a};
   };
   var incomingDonor = A2($Signal.map,OKDonor,okDonor);
   var NoOp = {ctor: "NoOp"};
   var gotDetails = true;
   var noDetails = false;
   ...
   var app = $StartApp.start({init: init
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([incomingActions,incomingDonor])});
   var main = app.html;
